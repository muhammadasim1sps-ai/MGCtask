...
# load_dotenv()  # loads OPENAI_API_KEY (and optionally OPENAI_MODEL) from a .env file
...
# RAW_FILES = {
#     "brochure": ("data/01_mgc_aurora_heights_brochure.md", "MGC Brochure"),
#     "price_list": ("data/02_price_list_payment_plan.md", "MGC Price List"),
#     "booking_faq": ("data/03_booking_policy_faq.md", "MGC Booking Policy & FAQ"),
# }
...
#     """Send the retrieved context + a strict system prompt to an OpenAI model.

#     Returns None if no API key is configured, so the caller can fall back
#     to showing the raw excerpt instead.
#     """
